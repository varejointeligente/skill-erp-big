---
name: erp-big
description: Base de conhecimento do ERP Big (BigPharma / Big Sistemas), o ERP de farmácia cujo banco é MariaDB na base `gerente`. Use SEMPRE que aparecer "ERP Big", "BigPharma", "base gerente", ou tabelas/colunas desse ERP — `movment`, `numlanc`, `oper`, `estoque_minimo2`, `grupo_preco_produto`, `lote_novo`, `precosfilial`, `caixas`, `conf_caixa_loja`, `tipospgto`, `curvaabc`, `produtos_suspensos_compra`. Use também, mesmo sem o ERP ser nomeado, quando a tarefa for escrever ou revisar SQL/relatório de farmácia sobre faturamento, cupons, ticket médio, margem, CMV, curva ABC, ruptura, demanda, estoque por filial, validade/lote, preço e oferta, desconto à vista, conferência e diferença de fechamento de caixa, sangria e suprimento, transferência x remanejo, RFV de clientes, ou entregas — e o banco for MariaDB. Consultar antes de escrever a query, não depois: a maior parte dos erros nesse ERP vem de armadilhas conhecidas (fan-out de JOIN, IDs não únicos entre filiais, soft delete, hierarquia de preço) que estão catalogadas aqui.
---
